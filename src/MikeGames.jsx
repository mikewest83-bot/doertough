...
const GAMES = [
  ...
  },
  {
    ...
    starter: 'Let’s play 20 Questions. I’ll think of something and you get up to 20 yes-or-no questions to guess it. Ask one question at a time, number each question, and make a guess when you are confident. After question 20, make your final guess and end the game unless I ask to play again.',
  },
  {
    id: 'would-you-rather',
    ...
    starter: 'Let’s play Would You Rather. Give me one tough or funny choice at a time, wait for my pick, react to it, then hit me with the next one. Keep going until I say stop.',
  },
  {
    id: 'higher-lower',
    ...
    starter: 'Let’s play Higher or Lower. Pick a category, give me a starting number, then make me guess higher or lower one round at a time, reveal the answer after each guess, and keep a running score.',
  },
  {
    id: 'riddle-me',
    ...
    starter: 'Let’s play Riddle Me This. Give me one riddle at a time, wait for my answer before revealing anything, offer a hint if I ask, and keep score. Keep going until I say stop.',
  },
  {
    id: 'two-truths',
    title: 'Two Truths',
    ...
    starter: 'Let’s play Two Truths and a Lie. Give me three numbered statements, tell me to guess the lie, wait for my guess, then reveal which one was false and keep score.',
  },
  {
    id: 'money-move',
    title: 'Money Move',
    ...
    starter: 'Let’s play Money Move. Give me realistic money and negotiation scenarios one at a time, let me choose what I would do, then score my move and explain the better play. Keep a running score.',
  },
  {
    id: 'deal-or-no-deal',
    ...
    starter: 'Let’s play Deal or No Deal. Give me a realistic negotiation with an offer, hidden upside, and downside. I decide deal or no deal, then you reveal what I could have won or lost and keep a running tally.',
  },
];
