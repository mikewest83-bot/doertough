  ...
  return (
    <div className="owner-overlay" role="dialog" aria-modal="true" aria-label="Owner Access">
      <style>{`
        ...
        .owner-grid{display:grid;grid-template-columns:1.4fr 1fr;gap:12px;padding:0 28px 14px}.owner-panel{border:1px solid #ffffff12;border-radius:15px;background:#0d1217;overflow:hidden}.owner-panel-head{padding:16px 18px;border-bottom:1px solid #ffffff0d}.owner-panel-head h3{margin:0;font-size:17px}.owner-panel-head p{margin:4px 0 0;color:#6e7880;font-size:11px}.owner-event{display:grid;grid-template-columns:8px 1fr auto;gap:12px;align-items:center;padding:13px 18px;border-bottom:1px solid #ffffff09}.owner-event:last-child{border-bottom:0}.owner-event i{width:8px;height:8px;border-radius:50%;background:#ff7b27}.owner-event strong{display:block;font-size:12px}.owner-event small{display:block;margin-top:3px;color:#6e7880;font-size:10px}.owner-event time{color:#69737b;font-size:9px}.owner-quick{padding:10px}.owner-quick div{display:flex;align-items:center;gap:10px;padding:14px 11px;margin-bottom:7px;border:1px solid #ffffff0c;border-radius:10px;background:#ffffff03}.owner-quick div:last-child{margin-bottom:0}.owner-quick span{color:#ff7b27;font-size:17px}.owner-quick strong{display:block;font-size:12px}.owner-quick small{display:block;margin-top:3px;color:#6d777f;font-size:10px}.owner-quick b{margin-left:auto;color:#68727a;font-size:20px;font-weight:400}.owner-status{margin:0 28px 14px}.owner-status-row{display:grid;grid-template-columns:repeat(3,1fr)}.owner-status-row div{padding:15px 18px;border-right:1px solid #ffffff09;font-size:12px}.owner-status-row div:last-child{border-right:0}.owner-status-row b{float:right;color:#2bd866}.owner-footer{margin:0 28px 24px;padding:12px;border:1px solid #ffffff0c;border-radius:10px;text-align:center;color:#69737b;font-size:10px}
