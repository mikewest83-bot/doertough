...
//
// Owner-only code tools. Mike can inspect the repository and save complete-file
// drafts for review. These tools never expose secrets, execute arbitrary shell,
// write .github workflows, or write directly to production.
